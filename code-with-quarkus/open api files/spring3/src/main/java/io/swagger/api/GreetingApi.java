...
public interface GreetingApi {
    ...
    @ApiOperation(value = "", nickname = "greetingNameGet", notes = "", response = String.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = String.class) })
    @RequestMapping(value = "/greeting/{name}",
        produces = { "text/plain" }, 
        method = RequestMethod.GET)
    ResponseEntity<String> greetingNameGet(@ApiParam(value = "",required=true) @PathVariable("name") String name
);
