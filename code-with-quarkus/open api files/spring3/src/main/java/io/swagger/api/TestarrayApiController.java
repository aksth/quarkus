...
@Controller
public class TestarrayApiController implements TestarrayApi {

    private static final Logger log = LoggerFactory.getLogger(TestarrayApiController.class);
    ...
    public TestarrayApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<ListGroup> testarrayGet() {
