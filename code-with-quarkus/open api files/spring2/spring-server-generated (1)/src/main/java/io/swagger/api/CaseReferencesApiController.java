...
@Controller
public class CaseReferencesApiController implements CaseReferencesApi {

    private static final Logger log = LoggerFactory.getLogger(CaseReferencesApiController.class);
    ...
    public CaseReferencesApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Void> sEQCaseRetrieveGetthesystemIDofacase(@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "caseId", required = true) String caseId
