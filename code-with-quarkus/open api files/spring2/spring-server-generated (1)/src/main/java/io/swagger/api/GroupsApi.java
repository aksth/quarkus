...
public interface GroupsApi {
    ...
    @ApiOperation(value = "SEQ-pre-group-case-template: Get the case template for a group", nickname = "sEQPreGroupCaseTemplateGetthecasetemplateforagroup", notes = "Find out what fields are available/required when entering cases into a specific group", response = TemplateObjectResponse.class, tags={ "Misc", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "", response = TemplateObjectResponse.class) })
    @RequestMapping(value = "/groups/{group-id}/caseTemplate",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<TemplateObjectResponse> sEQPreGroupCaseTemplateGetthecasetemplateforagroup(@ApiParam(value = "" ,required=true) @RequestHeader(value="Date", required=true) String date
...
,@ApiParam(value = "",required=true) @PathVariable("group-id") String groupId
    ...
    @ApiOperation(value = "SEQ-pre-groups: Get my top-level groups", nickname = "sEQPreGroupsGetmytopLevelgroups", notes = "Fetch the root groups accessible to my API user", response = ListGroupResponse.class, tags={ "Misc", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "", response = ListGroupResponse.class) })
    @RequestMapping(value = "/groups",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<ListGroupResponse> sEQPreGroupsGetmytopLevelgroups(@ApiParam(value = "" ,required=true) @RequestHeader(value="Date", required=true) String date
,@ApiParam(value = "" ,required=true) @RequestHeader(value="org.akash.Authorization", required=true) String authorization
,@ApiParam(value = "",required=true) @PathVariable("gateway-host") String gatewayHost
,@ApiParam(value = "",required=true) @PathVariable("gateway-url") String gatewayUrl
);
