...
,@ApiParam(value = "",required=true) @PathVariable("worldcheck-profile-id") String worldcheckProfileId
    ...
    @ApiOperation(value = "SEQ-pre-country-list: Get the ISO country list", nickname = "sEQPreCountryListGettheISOcountrylist", notes = "Fetch the ISO country list to use when providing case secondary fields related to countries/locations.", tags={ "Misc", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "") })
    @RequestMapping(value = "/reference/countries",
        method = RequestMethod.GET)
    ResponseEntity<Void> sEQPreCountryListGettheISOcountrylist(@ApiParam(value = "" ,required=true) @RequestHeader(value="Date", required=true) String date
,@ApiParam(value = "" ,required=true) @RequestHeader(value="org.akash.Authorization", required=true) String authorization
,@ApiParam(value = "",required=true) @PathVariable("gateway-host") String gatewayHost
,@ApiParam(value = "",required=true) @PathVariable("gateway-url") String gatewayUrl
);
