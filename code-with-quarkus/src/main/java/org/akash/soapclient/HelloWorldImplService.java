 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://javatpoint.com/", wsdlLocation = "http://localhost:7779/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://javatpoint.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://javatpoint.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://javatpoint.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
