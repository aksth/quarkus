 ...
 * generated in the com.akash.jaxws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://javatpoint.com/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://javatpoint.com/", "getHelloWorldAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.akash.jaxws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javatpoint.com/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javatpoint.com/", name = "getHelloWorldAsString")
